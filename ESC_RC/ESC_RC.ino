...
void loop(){
  ...
  Serial.print("receiver_input_channel_2: ");Serial.print(receiver_input_channel_2);Serial.print("\t");
  Serial.print("receiver_input_channel_1: ");Serial.print(receiver_input_channel_1);Serial.print("\n");
